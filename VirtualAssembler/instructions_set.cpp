...
std::map<virtual_actions, byte> instructions_set = {
	...
	{virtual_actions::jmp,    0x73},
	{virtual_actions::cmp,    0x74},
	{virtual_actions::je,     0x75},
	{virtual_actions::jne,    0x76},
	{virtual_actions::jl,     0x77},
	{virtual_actions::jg,     0x78},
	{virtual_actions::jle,    0x79},
	{virtual_actions::jge,    0x7A},
	{virtual_actions::cmpstr, 0x7B},
	
	{virtual_actions::gca,    0x7C},
	{virtual_actions::hlt,    0x7D},
	{virtual_actions::call,   0x7E},
	{virtual_actions::lcall,  0x7F},
	{virtual_actions::ret,    0x80},
	{virtual_actions::svcall, 0x81},
	{virtual_actions::rscall, 0x82},

	{virtual_actions::_dlog,   0x83},
	{virtual_actions::_dlog2,  0x84},
	{virtual_actions::_dlog10, 0x85},
	{virtual_actions::_dpow,   0x86},

	{virtual_actions::movsm,   0x87},
	{virtual_actions::movgm,   0x88},

	{virtual_actions::movsmSR, 0x89},
	{virtual_actions::movgmSR, 0x8A},

	{virtual_actions::movsmCR, 0x8B},
	{virtual_actions::movgmCR, 0x8C},

	{virtual_actions::movsmDR, 0x8D},
	{virtual_actions::movgmDR, 0x8E},

	{virtual_actions::nsms,	   0x8F},

	{virtual_actions::nopen,   0x90},
	{virtual_actions::nclose,  0x91},
	{virtual_actions::nget,	   0x92},
	{virtual_actions::nsend,   0x93},
	{virtual_actions::nhrecv,  0x94},
	{virtual_actions::ncrtep,  0x95},
	{virtual_actions::nselep,  0x96},

	{virtual_actions::pcrtthread, 0x97},
	{virtual_actions::prstthread, 0x98},
	{virtual_actions::pendthread, 0x99}
};
