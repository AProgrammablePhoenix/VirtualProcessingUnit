...
std::map<virtual_actions, byte> instructions_set = {
	...
	{virtual_actions::getAt,	  0x6A},
	{virtual_actions::getDynSize, 0x6B},

	{virtual_actions::dyndecl, 0x6C},
	{virtual_actions::dynset,  0x6D},
	{virtual_actions::dynget,  0x6E},

	{virtual_actions::_struct,			0x6F},
	{virtual_actions::_struct_declprop, 0x70},
	{virtual_actions::_struct_select,   0x71},
	{virtual_actions::_struct_get,		0x72},
	{virtual_actions::_struct_set,      0x73},

	{virtual_actions::_not, 0x74},
	{virtual_actions::_and, 0x75},
	{virtual_actions::_or,  0x76},
	{virtual_actions::_xor, 0x77},
	{virtual_actions::_shl, 0x78},
	{virtual_actions::_shr, 0x79},
	
	{virtual_actions::_log,   0x7A},
	{virtual_actions::_log2,  0x7B},
	{virtual_actions::_log10, 0x7C},
	{virtual_actions::_pow,   0x7D},

	{virtual_actions::ijmp,   0x7E},
	{virtual_actions::jmp,    0x7F},
	{virtual_actions::cmp,    0x80},
	{virtual_actions::je,     0x81},
	{virtual_actions::jne,    0x82},
	{virtual_actions::jl,     0x83},
	{virtual_actions::jg,     0x84},
	{virtual_actions::jle,    0x85},
	{virtual_actions::jge,    0x86},
	{virtual_actions::cmpstr, 0x87},
	
	{virtual_actions::gca, 0x88},
	{virtual_actions::hlt, 0x89},

	{virtual_actions::call,   0x8A},
