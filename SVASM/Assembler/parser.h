...
constexpr int INST_ERROR = -3; // error on instruction (doesn't exist or syntax error)
...
constexpr int WRONGNARGS = -6; // Wrong number of arguments given the used instruction
